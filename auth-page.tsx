    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 p-6 md:p-12">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-primary to-blue-600 bg-clip-text text-transparent">UAV Monitor</h1>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary/80 to-blue-700 items-center justify-center p-12">
        <div className="max-w-lg text-white">
          <h2 className="text-3xl font-bold mb-6">Advanced UAV Fleet Monitoring System</h2>
          <ul className="space-y-6">
            <li className="flex items-start">
              ...
              <div>
                <span className="font-medium block mb-1">Real-time UAV Monitoring</span>
