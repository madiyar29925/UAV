...
export default function AnalyticsPage() {
  ...
  // Fetch telemetry data for selected UAV
  useEffect(() => {
    const fetchTelemetryData = async () => {
      if (selectedUavId === 'all') {
        // Load a sample from each UAV for overview
        const promises = uavs
            ...
            <div className="mb-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  ...
                  <p className="text-neutral-500 mt-1">Data analysis and statistics for your UAV fleet</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              <Card>
                <CardHeader className="pb-2">
                  <CardTitle className="text-sm font-medium text-neutral-500">Active UAVs</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-neutral-500 mt-1">Across all active UAVs</p>
                </CardContent>
              </Card>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>Current state of the UAV fleet</CardDescription>
                    </CardHeader>
                    <CardContent>
