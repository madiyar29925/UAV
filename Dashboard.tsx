          ...
          <div className="container mx-auto px-4 py-6">
            ...
            <div className="mb-6">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                  <h1 className="text-2xl font-bold text-neutral-800">Real-time UAV Monitoring</h1>
                  <p className="text-neutral-500 mt-1">Overview of your UAV fleet status and telemetry</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Left Column - UAV List and Status */}
              <div className="lg:col-span-1">
                <UavList />
                <AlertsList />
              </div>
              
              {/* Middle Column - Selected UAV Details */}
              <div className="lg:col-span-2">
                {selectedUav ? (
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-neutral-100 p-8 text-center">
                    ...
                    <h2 className="text-xl font-semibold text-neutral-700">No UAV Selected</h2>
                    <p className="text-neutral-500 mt-2">Select a UAV from the list to view detailed information</p>
                  </div>
                )}
              </div>
            </div>
